...
def parse_args():
    ...
    parser.add_argument("--img_dir", default="/media/ders/sdc1/FJM/datasets/Paper3mul/Is512s512/test/images/")  # 原始图像
    parser.add_argument("--mask_dir", default="/media/ders/sdc1/FJM/datasets/Paper3mul/Is512s512/test/labels/")  # 真是标签
    parser.add_argument("--mask_npy_dir",
                        default="/media/ders/sdc1/FJM/datasets/Paper3mul/Is512s512/test/classification/")
    parser.add_argument("--pseudo_label_dir", default="/media/ders/sdc1/FJM/115P4mul_ipc_AP_SAM/experimentsI512s512_SFC/segmentation/predictions/pred_label/")  # 伪标签
    parser.add_argument("--sam_mask_dir", default="/media/ders/sdc1/FJM/P3_S2C_SAM/I512s512_test/")
    ...
    parser.add_argument("--output_refined_pseudo_dir", default="/media/ders/sdc1/FJM/115P4mul_ipc_AP_SAM/experimentsI512s512_SFC/Refined_seg/result0.1/")  # ours伪标签
...
if __name__ == "__main__":
    ...
    label_npy = masks_npy_dir + 'test_.npy'  # 存标签图片的文件夹
