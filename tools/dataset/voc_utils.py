...
def get_color_map_dic():
    ...
    labels = ['BG', 'GTF', 'SBF', 'SV', 'SH', 'BR', 'BC', 'BD', 'RA', 'PL', 'TC', 'LV', 'ST', 'HA', 'SP', 'HC']
    colormap = [[0, 0, 0], [0, 63, 255], [0, 127, 191], [0, 0, 127], [0, 0, 63], [0, 127, 63], [0, 63, 191], [0, 63, 0],
                [0, 191, 127], [0, 127, 255], [0, 63, 127], [0, 127, 127], [0, 63, 63], [0, 100, 155], [0, 0, 255],
                [0, 0, 191]]
