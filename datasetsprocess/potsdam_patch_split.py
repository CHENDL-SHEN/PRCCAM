...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="/media/ders/sdc1/FJM/datasets/Generality/P_fen/origion2/test/images")
    parser.add_argument("--mask-dir", default="/media/ders/sdc1/FJM/datasets/Generality/P_fen/origion2/test/labels")
    parser.add_argument("--output-img-dir", default="/media/ders/sdc1/FJM/datasets/Generality/P256s256/crop2/test/images/")
    parser.add_argument("--output-mask-dir", default="/media/ders/sdc1/FJM/datasets/Generality/P256s256/crop2/test/labels/")
    parser.add_argument("--vis_output_mask_dir", default="/media/ders/sdc1/FJM/datasets/Generality/P256s256/crop2/test/labels_vis/")
    ...
    parser.add_argument("--rgb-image", default=True)
...
def patch_format(inp):
    (img_path, mask_path, imgs_output_dir, masks_output_dir, vis_masks_output_dir, eroded, gt, rgb_image,
        ...
        for y in range(0, img.shape[0], stride):
            for x in range(0, img.shape[1], stride):
                ...
                if img_tile.shape[0] == split_size and img_tile.shape[1] == split_size \
                    ...
                    if mode == 'train':
                        if 0 < cf[0] < 0.1 or 0 < cf[1] < 0.1 or 0 < cf[2] < 0.1 or 0 < cf[3] < 0.1 or 0 < cf[4] < 0.025 or 0 < cf[5] < 0.1:  # ignore car_aug, no improvement
                            continue
                        else:
                            ...
                            for i in range(len(car_imgs)):
                               ...
                               vis_out_mask_path = os.path.join(vis_masks_output_dir,
                                                                         "{}_{}_{}_{}.png".format(mask_filename, m, k,
                                                                                                  i))
...
if __name__ == "__main__":
    ...
    inp = [(img_path, mask_path, imgs_output_dir, masks_output_dir, vis_masks_output_dir, eroded, gt, rgb_image,
