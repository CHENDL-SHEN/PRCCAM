...
parser.add_argument('--data_dir', default='/media/ders/Fjmnew/datasets/VRSI256nozq/', type=str)
...
###############################################################################
parser.add_argument('--model_name', default='resnet50aff', type=str)

parser.add_argument('--cam_dir', default='CAM@train@scale=0.5,1.0,1.5,2.0', type=str)
...
if __name__ == '__main__':
    ...
    cam_dir = f'./experiments256nozq/CAM/CAMnpy/{args.cam_dir}/'
    pred_dir = create_directory(f'./experiments256nq/Aff256/Aff_predictions/{experiment_name}/')

    model_path = './experiments256nozq/Aff256/Aff_Train/models/' + f'{args.model_name}.pth'
